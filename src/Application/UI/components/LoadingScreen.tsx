        ...
        >
                ...
                >
                    ...
                    >
                        ...
                        <div style={styles.headerInfo}>
                            ...
                            <p>OHMXO BIOS (C)2000 Ohmxo Jacob Inc.,</p>
                        </div>
                    </div>
                    <div style={styles.body} className="loading-screen-body">
                        <p>OHMXO S13 2000-2022 Special UC131S</p>
                        <div style={styles.spacer} />
                        {showBiosInfo && (
                            <>
                                <p>OHMXO Showcase(tm) XX 113</p>
            ...
            >
                <div style={styles.startPopup}>
                    ...
                    <div style={styles.spacer} />
                    <div style={styles.spacer} /> */}
                    <p>OHMXO Portfolio Showcase 2022</p>
                    {mobileWarning && (
                        <>
                            <br />
                            <b>
